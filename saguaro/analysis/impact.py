...
class ImpactAnalyzer:
    ...
    def analyze_change(self, file_path: str, symbol: str = None) -> Dict:
        ...
        interfaces = [f for f in dependents if f not in tests] # Source code dependdents
    ...
    def _find_build_targets(self, file_path: str) -> List[str]:
        ...
        while current.startswith(self.repo_path):
            ...
            for bf in ['setup.py', 'CMakeLists.txt', 'package.json', 'Makefile', 'BUILD', 'pyproject.toml']:
