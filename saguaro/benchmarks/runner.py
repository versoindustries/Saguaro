...
class BenchmarkRunner:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        logger.info(f"Running benchmark on {self.dataset_name} with {len(queries)} queries...")
        ...
        results["accuracy_score"] = results["successful_retrievals"] / len(queries) if queries else 0
