...
class SAGUAROClient:
    ...
    def _send_request(self, method: str, params: Dict[str, Any] = None) -> Any:
        ...
        try:
            ...
            if response.get("id") != req_id:
                 ...
                 logger.warning(f"ID mismatch: expected {req_id}, got {response.get('id')}")
    ...
    def read_node(self, entity: Dict[str, Any]) -> str:
        ...
        """
        res = self._send_request("read_node", {
            "file": entity.get("file"),
            "start_line": entity.get("line"), # Start line from index
            "end_line": entity.get("end_line") # End line from index (if available)
        })
